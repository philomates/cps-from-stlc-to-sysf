...
Lemma is_path_in_nodes_l : forall A (g:graph A) x y p,
  is_path g x y p -> x \inLN nodes g.
Proof. introv H. induction~ H. Qed.

Lemma is_path_in_nodes_r : forall A (g:graph A) x y p,
  is_path g x y p -> y \inLN nodes g.
