...
Lemma var_gen_list_spec : forall n l,
  n \inLN from_list l -> n < var_gen_list l.
Proof.
...
Ltac notin_simpl :=
  match goal with 
  | |- _ \notinLN (_ \u _) => apply notin_union_l; notin_simpl 
  | |- _ \notinLN (\{}) => apply notin_empty; notin_simpl
