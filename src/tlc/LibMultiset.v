...
(** [in_union_get] solves a goal of the form
    [x \inLN F1 \u ... \u FN] when there exists an 
    hypothesis of the form [x \inLN Fi] for some [i]. *)
...
Ltac multiset_in_inv_base H M :=
  match type of H with
  | _ \inLN \{} => false; apply (@in_empty_inv _ _ H)  
  | _ \inLN \{_} => 
